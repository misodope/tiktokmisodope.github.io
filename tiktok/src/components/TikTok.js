...
import { faTimes, faSpinner, faPlayCircle } from "@fortawesome/free-solid-svg-icons";
  ...
  return (
    <div className="tiktok">
      <div className={containerClass}>
        ...
        <FontAwesomeIcon onClick={onClick} className={playClass} icon={faPlayCircle} size="4x" color="#fece09" />
        <FontAwesomeIcon className={loaderClass} icon={faSpinner} size="4x" color="#fece09" rotation={90} />
      </div>
      <FontAwesomeIcon className={closeIconClass} icon={faTimes} onClick={onExit} />
