...
const linkData = [
  ...
  },
  {
    ...
    url:
      "https://open.appacademy.io/signup/free?utm_source=partner&utm_medium=tiktok&utm_campaign=miso-dope&utm_content=open",
  },
  {
    icon: FlexiSpot,
...
export const Links = () => {
  const linkElements = linkData.map((link) => {
    return (
      <a
        className="flex items-center link link__button cursor-pointer"
        href={link.url}
      >
